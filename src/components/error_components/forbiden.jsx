  ...
  return (
    <div className="flex h-screen items-center justify-center bg-gray-900 text-white">
      <div className="text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-red-600">Forbidden!</h1>
        <h2 className="text-2xl md:text-3xl mb-8">Code 403</h2>
        <p className="text-2xl md:text-3xl mb-8">Your actions and permission on our website is temporarily denied</p>
